...
//    /// </summary>
//    public static class ExceptionSerializer1
//    {
//        /// <summary>
...
//            // most of the time, Exceptions prefix the Exception type FullName to the ToString() return value but it is not required
//            // we add it here, but only if it is not already there
